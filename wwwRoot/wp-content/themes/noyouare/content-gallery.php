...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<p><em>
					...
					printf(
						...
						_n( 'This gallery contains <a %1$s>%2$s photo</a>.', 'This gallery contains <a %1$s>%2$s photos</a>.', $total_images, 'noyouare' ),
	...
	<footer class="entry-meta">
		...
		<span class="cat-links">
			...
			printf( __( '<span class="%1$s">Posted in</span> %2$s', 'noyouare' ), 'entry-utility-prep entry-utility-prep-cat-links', $categories_list );
			$show_sep = true;
			?>
		</span>
		...
		<span class="tag-links">
			...
			printf( __( '<span class="%1$s">Tagged</span> %2$s', 'noyouare' ), 'entry-utility-prep entry-utility-prep-tag-links', $tags_list );
			$show_sep = true;
			?>
		</span>
