 ...
 *
 * The showcase template in No You Are consists of a featured posts section using sticky posts,
...
wp_enqueue_script( 'noyouare-showcase', get_template_directory_uri() . '/js/showcase.js', array( 'jquery' ), '2011-04-28' );
		...
		<div id="primary" class="showcase">
			<div id="content" role="main">
				...
				<div class="featured-posts">
					<h1 class="showcase-heading"><?php _e( 'Featured Post', 'noyouare' ); ?></h1>
					...
					<section class="featured-post <?php echo esc_attr( $feature_class ); ?>" id="featured-post-<?php echo esc_attr( $counter_slider ); ?>">
						...
						<?php
							...
							if ( has_post_thumbnail() ) {
								...
								?>
								<a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'noyouare' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_post_thumbnail( $thumbnail_size ); ?></a>
								<?php
							}
						?>
				    ...
				    $counter_slider = 0;
						...
						while ( $featured->have_posts() ) : $featured->the_post();
							...
							if ( 1 == $counter_slider )
								...
								$class = '';
						?>
						<li><a href="#featured-post-<?php echo $counter_slider; ?>" title="<?php echo esc_attr( sprintf( __( 'Featuring: %s', 'noyouare' ), the_title_attribute( 'echo=0' ) ) ); ?>" <?php echo $class; ?>></a></li>
					<?php endwhile;	?>
					</ul>
				</nav>
				...
				<section class="recent-posts">
					<h1 class="showcase-heading"><?php _e( 'Recent Posts', 'noyouare' ); ?></h1>
					...
					while ( $recent->have_posts() ) : $recent->the_post(); ?>
						...
						<li class="entry-title">
							...
							<span class="comments-link">
								<?php comments_popup_link( '<span class="leave-reply">' . __( 'Leave a reply', 'noyouare' ) . '</span>', __( '<b>1</b> Reply', 'noyouare' ), __( '<b>%</b> Replies', 'noyouare' ) ); ?>
							</span>
						</li>
				...
				<div class="widget-area" role="complementary">
					<?php if ( ! dynamic_sidebar( 'sidebar-2' ) ) : ?>
						...
						<?php
						the_widget( 'No_You_Are_Ephemera_Widget', '', array( 'before_title' => '<h3 class="widget-title">', 'after_title' => '</h3>' ) );
						?>
