...
Digiprove does not make use of the registration information except to deliver the service.  Please read the terms of use (including privacy policy) at http://www.digiprove.com/termsofuse_page.aspx
...
<code><script type="text/javascript">var dprv_unlockPage=true;</script></code>
...
Each API key is associated with a domain (e.g. myinterestingblog.com, or www.myinterestingblog.com).
...
- Go to Settings, Copyright Proof
     ...
     - Ensure that Digiprove API Key is set to the right value for your domain name. Each API key is associated
       with a domain (e.g. myinterestingblog.com, or www.myinterestingblog.com). It will be 22 characters long.
...
There are limits to how many Digiprove operations will be processed per day, depending on your subscription level:
  ...
  Note if you are also using Digiprove's Autoprotect app (http://www.digiprove.com/autoprotect.aspx), these limits apply to the combined daily total of transactions from Autoprotect and Copyright Proof.
...
<script type="text/javascript">var dprv_unlockPage=true;</script>
...
* Required for clean integration with new WP Block Editor

= 4.01 =
* Definitely replace 4.00 with this

= 4.00 =
* Essential if you are using or plan to use the new Block-based Editor of Wordpress

= 3.09 =
* Recommended security upgrade for Digiprove subscribers

= 3.01 =
No need to upgrade unless you are encountering problems with Copyright Proof

= 3.00 =
Upgrade if you need support for AMP pages, want to Digiprove batches of older transactions
