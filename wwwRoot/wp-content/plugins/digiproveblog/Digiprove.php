<?php
define("DPRV_SDK_VERSION", '1.04');
define("DPRV_HOST", "api.digiprove.com");
define("DPRV_VERIFY_HOST", "api.digiprove.com");			// revert to verify.digiprove.com in future
//define("DPRV_SSL", "No");	// dropped from 1.04 onwards - use global $DPRV_SSL instead (defined by caller)
